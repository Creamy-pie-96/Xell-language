...
const XELL_TOKEN_RULES = [
    ...
    { scope: 'support.function.archive.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.bytes.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.casting.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.datetime.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.fs.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.generator.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.hash.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.json.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.list.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.map.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.network.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.process.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.regex.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.shell.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.string.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.sysmon.xell', settings: { foreground: '#eeeeee' } },
    { scope: 'support.function.textproc.xell', settings: { foreground: '#eeeeee' } },
    ...
    { scope: 'keyword.control.conditional.xell', settings: { foreground: '#e06c75', fontStyle: 'bold' } },
    ...
    { scope: 'keyword.control.trycatch.xell', settings: { foreground: '#d19a66', fontStyle: 'bold' } },
    { scope: 'keyword.other.binding.xell', settings: { foreground: '#61afef', fontStyle: 'bold' } },
    { scope: 'keyword.control.import.xell', settings: { foreground: '#e06c75', fontStyle: 'bold' } },
    { scope: 'keyword.control.module.xell', settings: { foreground: '#b267e6', fontStyle: 'bold' } },
    { scope: 'keyword.declaration.type.xell', settings: { foreground: '#56b6c2', fontStyle: 'bold' } },
    { scope: 'keyword.other.modifier.xell', settings: { foreground: '#56b6c2', fontStyle: 'bold italic' } },
    { scope: 'storage.modifier.xell', settings: { foreground: '#d19a66' } },
    { scope: 'keyword.control.yield.xell', settings: { foreground: '#e5c07b', fontStyle: 'bold' } },
    { scope: 'keyword.control.async.xell', settings: { foreground: '#61afef', fontStyle: 'bold' } },
    ...
    { scope: 'keyword.operator.shell.xell', settings: { foreground: '#98c379', fontStyle: 'bold' } },
    ...
    { scope: 'variable.other.xell', settings: { foreground: '#407747' } },
...
export function activate(context: vscode.ExtensionContext) {
    ...
    try {
        ...
        const notifyXesyChange = (uri: vscode.Uri) => {
